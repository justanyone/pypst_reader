...
byte index and parsed by `pypstreader.ndb.page` (whose checks are upstream's).
...
**Divergence: the walk is bounded — `pypstreader.limits`, wired here.** Rust's
...
from pypstreader.ndb.ids import BlockId, ByteIndex, NodeId, PageRef
