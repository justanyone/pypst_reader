...
A BTH is a B-tree whose pages are heap items (`pypstreader.ltp.heap`). Its
...
**Divergence: the walk is bounded — `pypstreader.limits`.** `bIdxLevels` is a
...
from pypstreader.ltp.heap import HeapId, HeapNode, HeapNodeType
