...
| P12-FUZZ | 2 | ⏳ in flight — agent/p12-fuzz 2026-09-15 | `tests/corrupt.py` mutation generator + the corruption suite: truncation, lying lengths, cyclic BTrees, bad CRCs, a 4 GB claim in a 265 KB file. Denial-first. | [`todo/T04-hardening.md`](todo/T04-hardening.md#p12-fuzz) |
