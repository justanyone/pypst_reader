...
| P08-FOLDER | 5 | ⏳ in flight — agent/p08-folder 2026-09-16 | `messaging/folder.py` — the folder hierarchy and its contents tables. First "open a PST and list the mail". | [`todo/T03-messaging.md`](todo/T03-messaging.md#p08-folder) |
