...
|---|---|---|
| **A · the port** (serial) | P23 → P01 → P02 (+P11) → P03 → P04 → P05 ∥ P06 → P07 → P08 → P09 → P10 | `src/pypstreader/ndb/`, `ltp/`, `messaging/` |
| **B · leaf modules** (each independent, run beside A) | P21 RTF · P22 property-type decoders · P28 spec vectors | `src/pypstreader/rtf.py`, `ltp/prop_type.py`, `tests/spec/` |
