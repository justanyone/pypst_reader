...
| P28-SPEC-VECTORS | 5 | ⏳ in flight — agent/p28-spec-vectors 2026-09-15 | `tests/spec/`: the worked byte examples in [MS-PST] and [MS-OXRTFCP], typed in from the spec rather than from upstream — the one tier that can catch a shared bug. | [`todo/T06-testing.md`](todo/T06-testing.md#p28-spec-vectors) |
